...
1. **Maintainer Preferences**: When creating a wishlist, maintainers can:
   - Select 1 preferred practitioner from our directory
   - Nominate someone from their community (subject to vetting)

2. **Sponsor Preferences**: When fulfilling a wishlist, sponsors can:
...
3. **Collaborative Matching**: We review:
