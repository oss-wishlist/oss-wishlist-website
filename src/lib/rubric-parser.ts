/**
 * Parse a peer-review rubric out of playbook markdown.
 *
 * Deliberately free of Astro imports so it can be tested directly: loading the
 * playbooks is rubrics.ts's job, reading them is this file's.
 *
